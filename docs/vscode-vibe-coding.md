...
2. Bấm icon 🔧 (**Tools**) → thấy nhóm `ak-docs` với 7 tool: `start_ak_project`, `search_ak_docs`, `get_ak_api`, `list_ak_api`, `get_ak_guide`, `get_ak_guardrails`, `analyze_ak_log` → tick bật.
...
- **Tools:** `start_ak_project`, `search_ak_docs`, `get_ak_api`, `list_ak_api`, `get_ak_guide`, `get_ak_guardrails`, `analyze_ak_log`
